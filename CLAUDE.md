...
- CTA персонализирован 22.02.2026: динамический текст + pre-filled Telegram. Ожидаем данные.
- Таймаут переосмыслен как диагностическая находка (amber, TTFB контекст, CTA)
