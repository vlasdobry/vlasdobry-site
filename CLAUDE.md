...
## Метрики роста (обновлено 15.03.2026)

**North Star Metric:** Health Score completions / неделю (текущее: ~2, цель: 15)

**Трафик (15.03):** 98 визитов/мес, 67 уник, 37.8% отказов, 3:10 среднее время, 2.2 стр/визит
**Источники:** Direct 66% (65), Link 16% (16), Search 13% (13), Internal 3% (3), Social 1% (1)
...
- 20 стартов → 15 завершений (75%) → 5 ошибок (25%) → **0 CTA кликов** (9 недель)
- Эксперимент #1 (редизайн CTA): FAIL — 0 кликов за 9 дней
- Эксперимент #2 (CTA в блоге): INCONCLUSIVE — 0 кликов, но всего 8 визитов в блог
- Эксперимент #3 (error rate): FAIL — 25% (было 27%), retry не помог

**Воронка 168-ФЗ:**
- 6 стартов → 4 завершения → 2 ошибки → **1 CTA клик**
