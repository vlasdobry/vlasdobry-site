...
## Метрики роста (обновлено 10.03.2026)

**North Star Metric:** Health Score completions / неделю (текущее: ~4, цель: 15)

**Трафик (10.03):** 90 визитов/мес, 61 уник, 37% отказов, 3:25 среднее время, 2.2 стр/визит
**Источники:** Direct 64% (58), Link 19% (17), Search 12% (11), Internal 3% (3), Social 1% (1)
**Яндекс:** 25 URL в поиске, 0 исключено, ИКС 10
**Google:** 14 кликов, 3368 показов, 16 страниц в индексе. 168-ФЗ EN-статья: 2712 показов, позиция 4.4. GEO-запрос «оптимизация сайта под ответы chatgpt»: 27 показов, позиция 59
**Mobile Performance (10.03):** LCP 7.0с (было 10.5с, цель <2.5с), FCP 5.2с, CLS 0, TTFB 46ms, Score 62

**Воронка Health Score:**
- 21 запуск → 16 завершений (76%) → 5 ошибок (24%) → **0 CTA кликов** (7 недель)
- Эксперимент #1 (редизайн CTA) реализован 06.03. Проверка 13.03
- Эксперимент #2 (CTA Health Score в блоге) реализован 08.03. Проверка 15.03

**Воронка 168-ФЗ:**
- 5 запусков → 3 завершения → 2 ошибки → **1 CTA клик**
