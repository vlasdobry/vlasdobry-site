...
**Трафик (апрель 2026):** 37 визитов/мес, 24 уник, 37.8% отказов, 6:51 среднее время, 2.5 стр/визит
**Трафик (май 2026, 1-16):** 38 визитов, 30 уник, 50% отказов, 4:58 среднее время, 4.8 стр/визит
**Источники (апрель):** Direct 31 (83.8%), Link 3 (8.1%), Social 2 (5.4%), Search 1 (2.7%)
**Источники (май):** Direct 33 (86.8%), Internal 3 (7.9%), Link 1 (2.6%), Social 1 (2.6%)
**Топ страницы (апрель):** Главная 22 (59%), EN статья 168-ФЗ 8 (22%), /#landing 2 (5%)
**Топ страницы (май):** Главная 21 (55%), EN статья 168-ФЗ 14 (37%), /168-fz/ 1 (3%)
**Яндекс:** ИКС 10, 54 страниц в поиске, 0 исключено. Поискового трафика практически нет (0 кликов)
**Google (апрель):** 1 клик, 231 показ, 0.0% CTR. EN 168-ФЗ статья: 110 показов, 1 клик, позиция 6.1
**Google (май, 1-15):** 0 кликов, 491 показ, 0.0% CTR. EN 168-ФЗ статья: 469 показов (95.5%), 0 кликов, позиция 7.9

**Воронка Health Score (апрель):**
- 12 стартов → 9 завершений (75%) → 3 ошибки (25%) → **0 CTA кликов** (14 недель без CTA)
- Апрель ещё держался на ~3 стартах/нед. В мае — **ноль**. Инструмент не используется.

**Воронка 168-ФЗ (апрель-май):**
- Апрель: 0 стартов, 0 завершений, 0 ошибок, 0 CTA
- Май: 0 стартов — инструмент полностью заброшен
- Эксперимент #4 (redirect fix, 01.04): некому проверять — воронка пустая
- Google продолжает давать показы EN статье (469/мес), но 0 кликов

**Контакты (апрель):** 0 WhatsApp, 0 Telegram, 0 Email, 0 Телефон — **ноль**
**Контакты (май, 1-16):** 1 Telegram (автоцель: переход в мессенджер)
