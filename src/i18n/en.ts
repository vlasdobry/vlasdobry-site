...
export const en: Translations = {
    ...
    footer: {
      ...
      nav: {
        offers: {
          label: 'Offers',
          items: [
            { name: 'For Hotels', url: '/en/for-hotels' },
            { name: 'For SPA', url: '/en/for-spa' },
            { name: 'For Labs', url: '/en/for-labs' },
          ],
        },
        services: {
          label: 'Services',
  ...
  compliance: {
    ...
    results: {
      ...
      spa: 'This website loads content via JavaScript, so automated analysis can only see the base HTML markup. The actual page may contain significantly more elements.',
      spaTitle: 'Limited analysis',
      spaAction: 'Order a manual review — I will analyze all website elements by hand.',
    ...
    seo: {
      ...
      methodology: {
        ...
        categories: [
          ...
          { name: 'Schema.org', description: 'Structured markup for rich snippets: LocalBusiness, Hotel, MedicalBusiness, Product, FAQ' },
      ...
      example: {
        ...
        recommendations: [
          ...
          'Add Schema.org markup (LocalBusiness, Hotel, MedicalBusiness, Product)',
        ],
    ...
    geo: {
      ...
      methodology: {
        ...
        categories: [
          ...
          { name: 'LLM Files', description: 'llms.txt and llms-full.txt — full site content for AI in one request' },
          { name: 'Structured Data', description: 'Schema.org markup — does AI understand your site structure' },
          { name: 'FAQ / Q&A', description: 'Structured answers to questions — easy for AI to cite' },
          { name: 'E-E-A-T Signals', description: 'Authorship, contacts, social links — trust signals for AI' },
      ...
      example: {
        ...
        scores: [
          ...
          { category: 'LLM Files', score: '0/10', status: 'Critical' },
          { category: 'Structured Data', score: '1/10', status: 'Critical' },
          { category: 'FAQ / Q&A', score: '0/10', status: 'Critical' },
          { category: 'E-E-A-T Signals', score: '3/10', status: 'Low' },
          { category: 'Factual Density', score: '5/10', status: 'Average' },
          { category: 'Reputation', score: '4/10', status: 'Low' },
        ],
        findings: [
          'llms.txt and llms-full.txt — missing',
          'Schema.org — missing',
          'FAQ markup — missing',
          'E-E-A-T — no authorship or contacts on pages',
          'Content — marketing phrases instead of facts',
        ],
        recommendations: [
          'Create llms.txt and llms-full.txt with full content',
          'Add Schema.org markup (LocalBusiness, Hotel, MedicalBusiness, FAQPage)',
          'Add FAQ section with structured answers',
          'Strengthen E-E-A-T: authorship, contacts, social links',
  ...
  projects: {
    ...
    items: [
      ...
      {
        name: 'My Finance',
        description: 'Personal finance web app. Budgets, spending analytics, recommendations.',
      ...
      },
      {
        ...
        description: 'Online wish-making platform with a cosmic visual experience. Animations, Google Sheets integration.',
      ...
      {
        name: 'Vocalis.Expert',
        description: 'Acoustic analysis and voice training platform. Spectrograms, AI coaching, 3D vocal biomechanics visualization, video sessions.',
    ...
    alsoBuilt: {
      label: 'Also built',
      items: [
        { name: 'Victory Diary', desc: 'Daily family achievement gamification — Google Apps Script + Telegram' },
