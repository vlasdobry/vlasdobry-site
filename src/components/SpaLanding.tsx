...
export const SpaLanding: React.FC = () => {
      ...
      <nav className={`sticky top-0 z-50 border-b transition-all duration-500 ease-out ${
        ...
        <div className={`max-w-5xl mx-auto px-6 sm:px-12 flex justify-between items-center transition-all duration-500 ease-out ${
          ...
          <div className="flex items-center gap-6">
            ...
            <LanguageSwitcher basePath="/for-spa" />
          </div>
          <a
            href={landingUrl}
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-12 py-16 md:py-24">
        ...
        <section className="py-16 border-t border-zinc-100" aria-labelledby="problems-heading">
          <h2 id="problems-heading" className="text-[10px] uppercase tracking-[0.3em] font-bold text-zinc-300 mb-12">
            {t.spa.problems.label}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            {t.spa.problems.items.map((item, i) => (
        ...
        <section className="py-16 border-t border-zinc-100" aria-labelledby="services-heading">
          <h2 id="services-heading" className="text-[10px] uppercase tracking-[0.3em] font-bold text-zinc-300 mb-12">
            {t.spa.services.label}
          </h2>
          <div className="space-y-12">
            {t.spa.services.items.map((item, i) => (
        ...
        <section className="py-16 border-t border-zinc-100" aria-labelledby="case-heading">
          ...
          <div className="bg-zinc-50 rounded-2xl p-8 md:p-12">
            ...
            <h3 className="text-3xl md:text-5xl font-black mb-2">{t.spa.caseStudy.title}</h3>
            <p className="text-lg text-zinc-400 font-light mb-6">{t.spa.caseStudy.subtitle}</p>

            <p className="text-zinc-600 mb-8 max-w-2xl">{t.spa.caseStudy.challenge}</p>

            <ul className="space-y-3 mb-10">
              {t.spa.caseStudy.done.map((item, i) => (
            ...
            <div className="flex gap-8 md:gap-16">
              {t.spa.caseStudy.results.map((result, i) => (
                <div key={i}>
        ...
        <section className="py-16 border-t border-zinc-100" aria-labelledby="process-heading">
          ...
          <p className="text-zinc-400 font-light mb-12">{t.spa.process.methodology}</p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {t.spa.process.steps.map((item) => (
        ...
        <section className="py-24 text-center border-t border-zinc-100" aria-labelledby="cta-heading">
          ...
          <p className="mt-6 text-zinc-400">
            {t.spa.cta.alternative}{' '}
            <a href={`mailto:${t.spa.cta.email}`} className="underline hover:text-black transition-colors">
              {t.spa.cta.email}
            </a>
          </p>
        </section>
        ...
        <footer className="py-16 flex flex-col md:flex-row justify-between items-center gap-8 border-t border-zinc-100">
          <div className="text-center md:text-left">
            <h4 className="text-xl font-bold">{t.spa.footer.name}</h4>
            <p className="text-zinc-400 text-sm font-light mt-1">{t.spa.footer.role}</p>
          </div>
