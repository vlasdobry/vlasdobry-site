  ...
  return (
    <main className="min-h-screen bg-white text-[#121212]">
      ...
      <footer className="max-w-5xl mx-auto px-6 sm:px-12 pt-16 pb-24 border-t border-zinc-100">
        <div className="flex flex-col md:flex-row justify-between gap-12">
          <div>
            ...
            <div className="flex gap-6 mt-4 text-[11px] font-bold tracking-[0.4em] uppercase text-zinc-400">
              ...
              <a href="mailto:vlas@vlasdobry.ru" onClick={() => analytics.clickEmail('compliance_footer')} className="hover:text-black">{ct.footer.links.email}</a>
            </div>
          </div>
        ...
        <div className="mt-12">
          <p className="text-zinc-300 text-sm">&copy; {new Date().getFullYear()} {ct.footer.name}</p>
